    ...
    <div className="min-h-screen bg-gray-100 flex flex-col p-4 md:p-8">
      ...
      <div className="w-full max-w-xl mx-auto mb-8">
        ...
        {availableWords.length > 0 && (
          <div className="mt-4">
            <p className="text-sm text-gray-500">Mots disponibles (stockés localement):</p>
            <div className="flex flex-wrap gap-2 mt-1">
      ...
      <div className="w-full max-w-2xl mx-auto bg-white rounded-lg shadow-md p-6">
        {loading ? (
          ...
          <div className="text-red-500 text-center py-6">
            <p>{error}</p>
            <p className="mt-2 text-sm">Essayez un autre mot ou vérifiez l'orthographe</p>
          </div>
        ) : definition ? (
          <div className="animate-fadeIn">
            {/* En-tête avec le mot recherché */}
            <div className="border-b pb-4 mb-4">
              <h2 className="text-2xl font-bold text-gray-900">{definition.word}</h2>
              {definition.category && (
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Définition</h3>
          ...
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="mt-2">Recherchez un mot pour afficher sa définition</p>
          </div>
        )}
      </div>
      
      <div className="w-full max-w-2xl mx-auto mt-6 text-center text-gray-400 text-xs">
        <p>Définitions fournies par notre serveur de dictionnaire</p>
      </div>
    </div>
  );
};
